// StepParameters_IdealDNA data file
// Nicolas Clauvelin


// IdealDNA force field intrinsic step parameters 


#ifndef emDNA_StepParameters_IdealDNA_h
#define emDNA_StepParameters_IdealDNA_h


const std::string StepParameters_IdealDNA[16] = {
...
#endif  // emDNA_StepParameters_IdealDNA_h
