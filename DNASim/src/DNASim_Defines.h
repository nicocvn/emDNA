...
#ifndef DNASIM_DEFINES_H
#define DNASIM_DEFINES_H
...
enum class RandomSeed : bool { Yes = true, No = false };
...
struct Array {
    ...
    // constructor
    Array(Size n, const ArrayType* const values) : _size(n), _values(values){};
};
...
void pointer_delete(PointerType* p) {
